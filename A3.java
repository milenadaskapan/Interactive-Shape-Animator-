...
public class A3  extends JFrame {
	...
	class AddListener implements ActionListener {
	    public void actionPerformed(ActionEvent e) {
	        ...
	        if (selectedNode==null) { 
	            ...
	            panel.model.addShapeNode((NestedShape) selectedNode);
	        } else {
	...
	class TreeNodeSelectionListener implements TreeSelectionListener {
	    public void valueChanged(TreeSelectionEvent e) {
	        ...
	        if ((t!=null)&&(t instanceof NestedShape)) {
	            panel.model.reload((NestedShape) t);
	        }
	    }
	}
	class RemoveListener implements ActionListener {
	    public void actionPerformed(ActionEvent e) {
	        ...
	        if (selectedNode == null) {
	            JOptionPane.showMessageDialog(panel, "ERROR: No node selected.");
	        } else if (selectedNode != panel.model.getRoot()) {
	            panel.model.removeNodeFromParent((Shape) selectedNode);
	        } else {
